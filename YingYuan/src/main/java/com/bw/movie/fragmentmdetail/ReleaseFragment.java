 ...
 * @Description:
 */
public class ReleaseFragment extends Fragment implements MyInterface.ViewInter.ReleaseMovie ,MyInterface.ViewInter.FollowInter {

    @BindView(R.id.release_recycler_id)
    XRecyclerView releaseRecyclerId;
    Unbinder unbinder;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        releaseRecyclerId.setLayoutManager(layoutManager);
        adapter = new MyDetailMovieAdapter(list, getActivity());
        releaseRecyclerId.setAdapter(adapter);
